...
public class DeliveryDTO implements Serializable {
    ...
    public DeliveryDTO(int delivery_ID, String delivery_Date, String delivery_Time, String delivery_State, double paid_Price, double total_Price, double balance){
