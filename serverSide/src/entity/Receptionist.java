...
public class Receptionist {
    ...
    public Receptionist(int receptionistID_PK,String receptionistF_Name,String receptionistL_Name,String receptionistAddress,String receptionistNicNO,int receptionistTel){
        this.setReceptionistID_PK(receptionistID_PK);
    ...
    public int getReceptionistID_PK() {
        return receptionistID_PK;
    }

    public void setReceptionistID_PK(int receptionistID_PK) {
        this.receptionistID_PK = receptionistID_PK;
    }
